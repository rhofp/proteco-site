<template>
    <div class="mb-3 mainR" style="flex: 1 0 auto;
		margin-top: 55px;">
		<!-- BANNER AZUL -->
		<div class="banner22 d-none d-md-block">
		</div>
		<!-- FORMULARIO -->
		<div class="card cardInicioS mx-auto">
			<div class="container">
				<div class="card-body bodyI">
					...
					<form class="fInicio pb-3" v-on:submit.prevent="loginSubmit">
						...
						<div class="form-check text-left pt-2">
							...
							<label class="form-check-label text-secondary" for="exampleCheck1">Recordar mis datos</label><br>
						</div>
						<br>
						<button type="submit" class="btn btn-primary">Iniciar Sesión</button>
					</form>
					<small class="text-left text-secondary pt-2 font-weight-bold" data-toggle="modal"
                           data-target="#exampleModalCenter" style="cursor: pointer;">¿Olvidaste tu contraseña?</small>
...
/*INICIO SESIÓN*/
	...
	.fInicio input, .fInicio select, .bodyI .modal input{
		border-style: none;
